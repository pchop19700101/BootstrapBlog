...
<div class="transparent_background side_container clearfix text-center">
    <div class="side_title">
        <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> <strong>博客日期</strong>
    </div>
...
<div class="transparent_background side_container clearfix text-center">
    <div class="side_title">
        <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <strong>博客类别</strong>
    </div>
