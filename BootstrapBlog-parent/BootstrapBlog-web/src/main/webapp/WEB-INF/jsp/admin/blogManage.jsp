...
<head>
    ...
    <script type="text/javascript">
        ...
        var columns = [[
            ...
            {field: 'blogTypeName', title: '博客类型', align: 'center', width: 20}
        ]];
        ...
        function openBlogModifyTab() {
            ...
            //调用父框架的方法
            window.parent.openTab("修改博客", "${pageContext.request.contextPath}/admin/blog/findById?id=" + rows[0].id, 'icon-writeblog');
        }
    </script>
</head>
<body>
