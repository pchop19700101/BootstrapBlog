...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteAllAndReimportIndex() {
            $.messager.confirm("系统提示", "您确定要重新导入博客到索引库吗?(时间比较长,请耐心等待)", function (r) {
                $.ajax({
                    ...
                    "success": function (data) {
                        if (data.message == 'success') {
                            $.messager.alert("系统提示", "重新导入博客到索引库成功！");
                        } else {
                            $.messager.alert("系统提示", "重新导入博客到索引库失败！");
                        }
                    },
                    "error": function () {
                        $.messager.alert("系统提示", "重新导入博客到索引库失败！");
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <%--<div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
            <a href="javascript:openTab('写博客','${pageContext.request.contextPath}/admin/page/writeBlog.html','icon-writeblog')"
        ...
        <div title="博客管理" data-options="iconCls:'icon-bkgl'" style="padding:10px;">
            <a href="javascript:openTab('写博客','${pageContext.request.contextPath}/admin/page/writeBlog.html','icon-writeblog')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writeblog'" style="width: 150px;">写博客</a>
            <a href="javascript:openTab('博客信息管理','${pageContext.request.contextPath}/admin/page/blogManage.html','icon-bkgl')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">博客信息管理</a>
        </div>
        <div title="博客类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
            <a href="javascript:openTab('博客类别信息管理','${pageContext.request.contextPath}/admin/page/blogTypeManage.html','icon-bklb')"
               class="easyui-linkbutton"
        ...
        <div title="系统管理" data-options="iconCls:'icon-system'" style="padding:10px">
            ...
            <a href="javascript:deleteAllAndReimportIndex()" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-refresh'" style="width: 150px;">重新导入博客到索引库</a>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
    Copyright © 2016-2018 blog.porkchop.cn 版权所有
</div>
