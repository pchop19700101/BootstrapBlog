...
<div id="p" class="easyui-panel" title="编辑资源" style="padding: 10px">
	<table cellspacing="20px">
		...
		<tr>
			<td></td>
			<td>
				<a href="javascript:submitData()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">发布资源</a>
			</td>
		</tr>
	</table>
</div>
